...
workbenchActionsRegistry.registerWorkbenchAction(new SyncActionDescriptor(ReadLocalStorage, ReadLocalStorage.ID, ReadLocalStorage.LABEL), 'Read Local Storage');
